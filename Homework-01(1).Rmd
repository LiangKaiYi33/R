...
sum(vector1)
```
solution:the type of the elements of vector1 is string, so the result of max(vector1) is "7". The result of sort(vector1) is "12" "32" "5" "7". Cause sum() can only be used to data whose type is int, so it will be error. 
